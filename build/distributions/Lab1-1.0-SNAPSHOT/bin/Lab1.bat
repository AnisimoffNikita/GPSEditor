...
set CLASSPATH=%APP_HOME%\lib\okio-1.13.0.jar;%APP_HOME%\lib\Lab1-1.0-SNAPSHOT.jar;%APP_HOME%\lib\sqlite-jdbc-3.21.0.1.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\jpx-1.2.3.jar;%APP_HOME%\lib\joda-time-2.9.9.jar;%APP_HOME%\lib\google-maps-services-0.2.6.jar;%APP_HOME%\lib\slf4j-nop-1.7.25.jar;%APP_HOME%\lib\gson-2.8.1.jar;%APP_HOME%\lib\okhttp-3.8.1.jar

@rem Execute Lab1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB1_OPTS%  -classpath "%CLASSPATH%" me.anisimoff.editor.App %CMD_LINE_ARGS%
